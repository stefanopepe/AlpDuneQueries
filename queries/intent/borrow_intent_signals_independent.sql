-- ============================================================
-- Query: borrow_intent_signals_independent
-- Description: Per-borrow intent signals with bounded outflow joins
-- ============================================================
...
SELECT
    ...
    'unclassified' AS intent_bucket,
    'signals_only' AS intent_reason,
    m.query_version,
    m.as_of_utc,
    m.parameter_hash
FROM cohort c
