-- ============================================================
-- Query: borrow_intent_classification_independent
-- Description: Per-borrow deterministic intent classification with reason codes
-- ============================================================
...
SELECT
    ...
    CASE
        WHEN y.signal_loop_24h THEN 'swap_to_btc_plus_collateral_add_within_24h'
        WHEN y.signal_loop_1h THEN 'swap_to_btc_plus_collateral_add_within_1h'
        WHEN y.signal_bridge_7d THEN 'bridge_registry_or_label_match'
        WHEN y.signal_offramp_7d THEN 'cex_label_or_eoa_dominant_outflow'
        WHEN y.signal_defi_7d THEN 'stable_outflow_to_contract_in_7d'
        ELSE 'no_positive_intent_signal'
...
CROSS JOIN meta m
ORDER BY y.borrow_time_utc, y.chain, y.protocol;
